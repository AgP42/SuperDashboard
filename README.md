...
| 3.29.43 (Manta/Nomad) / 2.26.40 (A5 X / A6 X) or later | **v1.0.2** |

Both builds are the same SuperDashboard. **v1.0.2** is rebuilt for `sn-plugin-lib` 0.1.65; on first open
...
zones go empty. Once these firmware versions ship publicly, v1.0.2 becomes the main build. Installing the
