...
export const ui = StyleSheet.create({
  ...
  // Clip action buttons (Label / Paste): bordered black pills, high contrast and
  ...
  // Per-clip card: a header band (source + labels, tap to collapse) + body.
  clipCard: {borderWidth: 1, borderColor: '#000000', borderRadius: 8, backgroundColor: '#ffffff', overflow: 'hidden'},
  clipCardHead: {flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 6, backgroundColor: '#f2f2f2', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#000000'},
  clipCardBody: {padding: 8},
  clipChevron: {fontSize: 15, color: '#000000', fontWeight: '700', paddingLeft: 8},
  // In-module label filter: "no label" chip (grey to set it apart from labels).
  clipNoLabel: {fontSize: 11, color: '#666666', borderWidth: 1, borderColor: '#999999', borderRadius: 999, paddingHorizontal: 7, paddingVertical: 1, marginRight: 5, marginBottom: 3},
  clipNoLabelOn: {fontSize: 11, color: '#ffffff', backgroundColor: '#777777', borderWidth: 1, borderColor: '#777777', borderRadius: 999, paddingHorizontal: 7, paddingVertical: 1, marginRight: 5, marginBottom: 3, overflow: 'hidden'},
